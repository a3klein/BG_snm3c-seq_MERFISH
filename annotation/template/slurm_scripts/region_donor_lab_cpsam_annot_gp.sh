...
# /home/x-aklein2/projects/aklein/BICAN/BG/annotation/execute/region_donor_lab_cpsam_gp/{EXP}_{DONOR}_{LAB2}/integrate.ipynb \
# -p spatial_adata_path /home/x-aklein2/projects/aklein/BICAN/BG/data/annotation/BICAN_BG_{{EXP}}_cellpose_SAM_filt/{{EXP}}.h5ad \
# -p save_path /home/x-aklein2/projects/aklein/BICAN/BG/annotation/execute/region_donor_lab_cpsam_gp \
# -p image_path /home/x-aklein2/projects/aklein/BICAN/BG/annotation/execute/region_donor_lab_cpsam_gp \