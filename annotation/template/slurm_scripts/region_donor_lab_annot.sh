...
pixi run \
    ...
    /home/x-aklein2/projects/aklein/BICAN/BG/annotation/execute/region_donor_lab/{EXP}_{DONOR}_{LAB1}/integrate.ipynb \
    -p EXP {EXP} \
    -p REF_EXP {REF_EXP} \
    -p DONOR {DONOR} \
    -p LAB {LAB1} \
...
pixi run \
    papermill \
    /home/x-aklein2/projects/aklein/BICAN/BG/annotation/template/01_region_donor_lab_annot.ipynb \
    /home/x-aklein2/projects/aklein/BICAN/BG/annotation/execute/region_donor_lab/{EXP}_{DONOR}_{LAB2}/integrate.ipynb \
    -p EXP {EXP} \
    -p REF_EXP {REF_EXP} \
    -p LAB {LAB2} \
    -p DONOR {DONOR} \
