...
#SBATCH --mem=128gb
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/agg/CP_cab.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/agg/CP_cab.out
#SBATCH --export=ALL
...
pixi run -e preprocessing python -m spida.P.cli setup-dataset BICAN_BG_CAB_ucsd_CPSfilt
...
pixi run -e preprocessing python -m spida.P.cli setup-dataset BICAN_BG_CAB_salk_CPSfilt
