...
#SBATCH --mem=128gb
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/agg/CPS_cah.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/agg/CPS_cah.out
#SBATCH --export=ALL
...
pixi run -e preprocessing python -m spida.P.cli setup-dataset BICAN_BG_CAH_ucsd_CPSfilt
...
pixi run -e preprocessing python -m spida.P.cli setup-dataset BICAN_BG_CAH_salk_CPSfilt
