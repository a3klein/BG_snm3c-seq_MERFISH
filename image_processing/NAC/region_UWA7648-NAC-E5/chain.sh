...
cd /home/x-aklein2/projects/aklein/BICAN/image_processing/NAC/region_UWA7648-NAC-E5
echo "Starting processing chain for Experiment NAC and Region region_UWA7648-NAC-E5"
...
echo "Processing chain for Experiment NAC and Region region_UWA7648-NAC-E5 has been initiated."