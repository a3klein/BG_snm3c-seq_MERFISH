...
#SBATCH -A mcb130189
#SBATCH -J proseg_NAC_region_UWA7648-NAC-E5
#SBATCH -p wholenode
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=128
#SBATCH --mem=128gb
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/NAC/proseg_NAC_region_UWA7648-NAC-E5.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/NAC/proseg_NAC_region_UWA7648-NAC-E5.out
#SBATCH --export=ALL
...
pixi run -e preprocessing \
    ...
    --input_dir /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506221112_BICAN4x1-NAC-E05_VMSC31810/cellpose/ \
    --output_dir /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506221112_BICAN4x1-NAC-E05_VMSC31810/${PREFIX} \
    --kwargs \
    voxel-layers=7 \
    ncomponents=10 \
...
pixi run -e preprocessing \
    ...
    202506221112_BICAN4x1-NAC-E05_VMSC31810 \
    region_UWA7648-NAC-E5 \
    /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506221112_BICAN4x1-NAC-E05_VMSC31810/${PREFIX} \
    --type proseg \
    --prefix_name ${PREFIX} \
    --plot
...
pixi run -e preprocessing python src/spida/I/main.py allcools-integration-region \
    ...
    region_UWA7648-NAC-E5 \
    ${PREFIX} \
    /home/x-aklein2/projects/aklein/BICAN/data/reference/AIT/AIT_NAC.h5ad \
