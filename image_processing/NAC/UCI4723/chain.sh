...
cd /home/x-aklein2/projects/aklein/BICAN/image_processing/NAC/UCI4723
echo "Starting processing chain for Experiment NAC and Region UCI4723"
...
echo "Processing chain for Experiment NAC and Region UCI4723 has been initiated."