...
cd /home/x-aklein2/projects/aklein/BICAN/image_processing/NAC/UWA7648
echo "Starting processing chain for Experiment NAC and Region UWA7648"
...
echo "Processing chain for Experiment NAC and Region UWA7648 has been initiated."