...
#SBATCH -J cellpose_NAC_region_UCI5224-NAC-E5
#SBATCH -p gpu
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --gpus-per-node=1
#SBATCH --ntasks-per-node=64
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/NAC/cellpose_NAC_region_UCI5224-NAC-E5.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/NAC/cellpose_NAC_region_UCI5224-NAC-E5.out
#SBATCH --export=ALL
...
echo "Running Cellpose SAM on Region region_UCI5224-NAC-E5 of Experiment NAC"
...
pixi run -e cellpose \
    ...
    --input_dir /anvil/scratch/x-aklein2/BICAN/202506221112_BICAN4x1-NAC-E05_VMSC31810/out/region_UCI5224-NAC-E5/images \
