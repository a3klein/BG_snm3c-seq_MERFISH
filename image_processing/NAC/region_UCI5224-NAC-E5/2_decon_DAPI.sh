...
#SBATCH -J decon_NAC_region_UCI5224-NAC-E5_D
#SBATCH -p gpu
#SBATCH --time=6:00:00
#SBATCH --nodes=1
#SBATCH --gpus-per-node=1
#SBATCH --ntasks-per-node=4
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/NAC/decon_NAC_region_UCI5224-NAC-E5_D.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/NAC/decon_NAC_region_UCI5224-NAC-E5_D.out
#SBATCH --export=ALL
...
echo "Running whole image deconvolution - DAPI - region_UCI5224-NAC-E5 - NAC"
