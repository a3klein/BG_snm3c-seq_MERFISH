...
cd /home/x-aklein2/projects/aklein/BICAN/image_processing/NAC/UCI2424
echo "Starting processing chain for Experiment NAC and Region UCI2424"
...
echo "Processing chain for Experiment NAC and Region UCI2424 has been initiated."