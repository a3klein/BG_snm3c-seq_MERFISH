...
#SBATCH -J cellpose_NAC_UCI2424
#SBATCH -p gpu
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --gpus-per-node=1
#SBATCH --ntasks-per-node=64
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/NAC/cellpose_NAC_UCI2424.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/NAC/cellpose_NAC_UCI2424.out
#SBATCH --export=ALL
...
echo "Running Cellpose SAM on Region UCI2424 of Experiment NAC"
