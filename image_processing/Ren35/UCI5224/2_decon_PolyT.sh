...
#SBATCH -J decon_Ren35_UCI5224_P
#SBATCH -p gpu
#SBATCH --time=6:00:00
#SBATCH --nodes=1
#SBATCH --gpus-per-node=1
#SBATCH --ntasks-per-node=4
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/Ren35/decon_Ren35_UCI5224_P.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/Ren35/decon_Ren35_UCI5224_P.out
#SBATCH --export=ALL
...
echo "Running whole image deconvolution - PolyT - UCI5224 - Ren35"
