...
#SBATCH -A mcb130189
#SBATCH -J proseg_Ren35_UCI2424
#SBATCH -p wholenode
#SBATCH --time=0:30:00
#SBATCH --nodes=1
#SBATCH --ntasks=128
#SBATCH --mem=128gb
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/Ren35/proseg_Ren35_UCI2424.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/Ren35/proseg_Ren35_UCI2424.out
#SBATCH --export=ALL
...
#     --input_dir /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506191430_20250619M204BICANRen35_VMSC32010/cellpose/ \
#     --output_dir /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506191430_20250619M204BICANRen35_VMSC32010/${PREFIX} \
#     --kwargs \
#     voxel-layers=7 \
#     ncomponents=10 \
...
#     202506191430_20250619M204BICANRen35_VMSC32010 \
#     region_UCI2424Q06CaH \
#     /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506191430_20250619M204BICANRen35_VMSC32010/${PREFIX} \
#     --type proseg \
#     --prefix_name ${PREFIX} \
#     --plot
