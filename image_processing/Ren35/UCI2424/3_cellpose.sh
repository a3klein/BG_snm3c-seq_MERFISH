...
#SBATCH -J cellpose_Ren35_UCI2424
#SBATCH -p gpu
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --gpus-per-node=1
#SBATCH --ntasks-per-node=64
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/Ren35/cellpose_Ren35_UCI2424.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/Ren35/cellpose_Ren35_UCI2424.out
#SBATCH --export=ALL
...
echo "Running Cellpose SAM on Region UCI2424 of Experiment Ren35"
...
pixi run -e cellpose \
    ...
    --input_dir /anvil/scratch/x-aklein2/BICAN/202506191430_20250619M204BICANRen35_VMSC32010/out/region_UCI2424Q06CaH/images \
    --output_dir /anvil/projects/x-mcb130189/aklein/BICAN/data/segmented/202506191430_20250619M204BICANRen35_VMSC32010/cellpose \
    --kwargs \
    scale=4 \
    image_ext=.decon.tif \
    nuc_stain_name=DAPI \
