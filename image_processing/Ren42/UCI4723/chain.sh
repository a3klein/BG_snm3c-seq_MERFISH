...
cd /home/x-aklein2/projects/aklein/BICAN/image_processing/Ren42/UCI4723
echo "Starting processing chain for Experiment Ren42 and Region UCI4723"
...
echo "Processing chain for Experiment Ren42 and Region UCI4723 has been initiated."