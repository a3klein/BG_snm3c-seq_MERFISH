...
#SBATCH -A mcb130189
#SBATCH -J proseg_Ren42_UCI2424
#SBATCH -p wholenode
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=128
#SBATCH --mem=128gb
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/Ren42/proseg_Ren42_UCI2424.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/Ren42/proseg_Ren42_UCI2424.out
#SBATCH --export=ALL
...
pixi run -e preprocessing \
    ...
    --input_dir /home/x-aklein2/projects/aklein/BICAN/data/segmented/202507071458_20250707M212BICANRen42_VMSC32010/cellpose/ \
    --output_dir /home/x-aklein2/projects/aklein/BICAN/data/segmented/202507071458_20250707M212BICANRen42_VMSC32010/${PREFIX} \
    --kwargs \
    voxel-layers=7 \
    ncomponents=10 \
...
pixi run -e preprocessing \
    ...
    202507071458_20250707M212BICANRen42_VMSC32010 \
    region_UCI2424Q02CaT \
    /home/x-aklein2/projects/aklein/BICAN/data/segmented/202507071458_20250707M212BICANRen42_VMSC32010/${PREFIX} \
    --type proseg \
    --prefix_name ${PREFIX} \
    --plot
