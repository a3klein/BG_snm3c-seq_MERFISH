...
cd /home/x-aklein2/projects/aklein/BICAN/image_processing/PU/region_UCI4723
echo "Starting processing chain for Experiment PU and Region region_UCI4723"
...
echo "Processing chain for Experiment PU and Region region_UCI4723 has been initiated."