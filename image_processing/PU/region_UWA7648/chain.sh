...
cd /home/x-aklein2/projects/aklein/BICAN/image_processing/PU/region_UWA7648
echo "Starting processing chain for Experiment PU and Region region_UWA7648"
...
echo "Processing chain for Experiment PU and Region region_UWA7648 has been initiated."