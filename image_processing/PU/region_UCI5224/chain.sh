...
cd /home/x-aklein2/projects/aklein/BICAN/image_processing/PU/region_UCI5224
echo "Starting processing chain for Experiment PU and Region region_UCI5224"
...
echo "Processing chain for Experiment PU and Region region_UCI5224 has been initiated."