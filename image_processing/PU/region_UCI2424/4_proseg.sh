...
#SBATCH -A mcb130189
#SBATCH -J proseg_PU_region_UCI2424
#SBATCH -p wholenode
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=128
#SBATCH --mem=128gb
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/PU/proseg_PU_region_UCI2424.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/PU/proseg_PU_region_UCI2424.out
#SBATCH --export=ALL
...
pixi run -e preprocessing \
    ...
    region_UCI2424 \
    --input_dir /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506151211_BICAN-4x1-PU-01_VMSC31910/cellpose/ \
    --output_dir /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506151211_BICAN-4x1-PU-01_VMSC31910/${PREFIX} \
    --kwargs \
    voxel-layers=7 \
    ncomponents=10 \
...
pixi run -e preprocessing \
    ...
    202506151211_BICAN-4x1-PU-01_VMSC31910 \
    region_UCI2424 \
    /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506151211_BICAN-4x1-PU-01_VMSC31910/${PREFIX} \
    --type proseg \
    --prefix_name ${PREFIX} \
    --plot
