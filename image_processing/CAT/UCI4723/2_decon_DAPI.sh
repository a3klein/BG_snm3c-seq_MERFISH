...
#SBATCH -J decon_CAT_UCI4723_D
#SBATCH -p gpu
#SBATCH --time=6:00:00
#SBATCH --nodes=1
#SBATCH --gpus-per-node=1
#SBATCH --ntasks-per-node=4
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/CAT/decon_CAT_UCI4723_D.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/CAT/decon_CAT_UCI4723_D.out
#SBATCH --export=ALL
...
echo "Running whole image deconvolution - DAPI - UCI4723 - CAT"
