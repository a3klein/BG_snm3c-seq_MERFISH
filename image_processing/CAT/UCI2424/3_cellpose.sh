...
#SBATCH -J cellpose_CAT_UCI2424
#SBATCH -p gpu
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --gpus-per-node=1
#SBATCH --ntasks-per-node=64
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/CAT/cellpose_CAT_UCI2424.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/CAT/cellpose_CAT_UCI2424.out
#SBATCH --export=ALL
...
echo "Running Cellpose SAM on Region UCI2424 of Experiment CAT"
...
pixi run -e cellpose \
    ...
    region_UCI-2424 \
    --input_dir /anvil/scratch/x-aklein2/BICAN/202506291134_BICAN-4x1-CAT-E-03_VMSC31910/out/region_UCI-2424/images \
    --output_dir /anvil/projects/x-mcb130189/aklein/BICAN/data/segmented/202506291134_BICAN-4x1-CAT-E-03_VMSC31910/cellpose \
    --kwargs \
    scale=4 \
    image_ext=.decon.tif \
    nuc_stain_name=DAPI \
