...
#SBATCH -A mcb130189
#SBATCH -J proseg_CAT_UCI5224
#SBATCH -p wholenode
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=128
#SBATCH --mem=128gb
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/CAT/proseg_CAT_UCI5224.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/CAT/proseg_CAT_UCI5224.out
#SBATCH --export=ALL
...
pixi run -e preprocessing \
    ...
    region_UCI-5224 \
    --input_dir /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506291134_BICAN-4x1-CAT-E-03_VMSC31910/cellpose/ \
    --output_dir /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506291134_BICAN-4x1-CAT-E-03_VMSC31910/${PREFIX} \
    --kwargs \
    voxel-layers=7 \
    ncomponents=10 \
...
pixi run -e preprocessing \
    ...
    202506291134_BICAN-4x1-CAT-E-03_VMSC31910 \
    region_UCI-5224 \
    /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506291134_BICAN-4x1-CAT-E-03_VMSC31910/${PREFIX} \
    --type proseg \
    --prefix_name ${PREFIX} \
    --plot
