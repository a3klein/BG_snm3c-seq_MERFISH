...
cd /home/x-aklein2/projects/aklein/BICAN/image_processing/CAT/UCI5224
echo "Starting processing chain for Experiment CAT and Region UCI5224"
...
echo "Processing chain for Experiment CAT and Region UCI5224 has been initiated."