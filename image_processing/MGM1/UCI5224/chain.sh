...
cd /home/x-aklein2/projects/aklein/BICAN/image_processing/MGM1/UCI5224
echo "Starting processing chain for Experiment MGM1 and Region UCI5224"
...
echo "Processing chain for Experiment MGM1 and Region UCI5224 has been initiated."