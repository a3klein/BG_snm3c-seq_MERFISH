...
#SBATCH -A mcb130189
#SBATCH -J proseg_MGM1_UCI5224
#SBATCH -p wholenode
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=128
#SBATCH --mem=128gb
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/MGM1/proseg_MGM1_UCI5224.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/MGM1/proseg_MGM1_UCI5224.out
#SBATCH --export=ALL
