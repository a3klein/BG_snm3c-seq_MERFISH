...
cd /home/x-aklein2/projects/aklein/BICAN/image_processing/MGM1/UCI4723
echo "Starting processing chain for Experiment MGM1 and Region UCI4723"
...
echo "Processing chain for Experiment MGM1 and Region UCI4723 has been initiated."