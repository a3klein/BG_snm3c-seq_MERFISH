...
cd /home/x-aklein2/projects/aklein/BICAN/image_processing/MGM1/UWA7648
echo "Starting processing chain for Experiment MGM1 and Region UWA7648"
...
echo "Processing chain for Experiment MGM1 and Region UWA7648 has been initiated."