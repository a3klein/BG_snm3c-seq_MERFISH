...
#SBATCH -J cellpose_MGM1_UWA7648
#SBATCH -p gpu
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --gpus-per-node=1
#SBATCH --ntasks-per-node=64
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/MGM1/cellpose_MGM1_UWA7648.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/MGM1/cellpose_MGM1_UWA7648.out
#SBATCH --export=ALL
...
echo "Running Cellpose SAM on Region UWA7648 of Experiment MGM1"
...
pixi run -e cellpose \
    ...
    region_UWA7648 \
    --input_dir /anvil/scratch/x-aklein2/BICAN/202506221112_BICAN-4x1-MGM1-E-03_VMSC31910/out/region_UWA7648/images \
