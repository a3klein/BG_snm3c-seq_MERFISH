...
#SBATCH -A mcb130189
#SBATCH -J proseg_MGM1_UWA7648
#SBATCH -p wholenode
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=128
#SBATCH --mem=128gb
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/MGM1/proseg_MGM1_UWA7648.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/MGM1/proseg_MGM1_UWA7648.out
#SBATCH --export=ALL
...
pixi run -e preprocessing \
    ...
    region_UWA7648 \
    --input_dir /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506221112_BICAN-4x1-MGM1-E-03_VMSC31910/cellpose/ \
    --output_dir /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506221112_BICAN-4x1-MGM1-E-03_VMSC31910/${PREFIX} \
    --kwargs \
    voxel-layers=7 \
    ncomponents=10 \
...
pixi run -e preprocessing \
    ...
    202506221112_BICAN-4x1-MGM1-E-03_VMSC31910 \
    region_UWA7648 \
    /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506221112_BICAN-4x1-MGM1-E-03_VMSC31910/${PREFIX} \
    --type proseg \
    --prefix_name ${PREFIX} \
    --plot
...
pixi run -e preprocessing python src/spida/I/main.py allcools-integration-region \
    ...
    region_UWA7648 \
    ${PREFIX} \
    /home/x-aklein2/projects/aklein/BICAN/data/reference/AIT/AIT_MGM1.h5ad \
