...
#SBATCH -A mcb130189
#SBATCH -J proseg_Ren36_UCI2424
#SBATCH -p wholenode
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=128
#SBATCH --mem=128gb
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/Ren36/proseg_Ren36_UCI2424.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/Ren36/proseg_Ren36_UCI2424.out
#SBATCH --export=ALL
...
pixi run -e preprocessing \
    ...
    region_UCI2424Q02Pu \
    --input_dir /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506191452_20250619M205BICANRen36_VMSC32110/cellpose/ \
    --output_dir /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506191452_20250619M205BICANRen36_VMSC32110/${PREFIX} \
    --kwargs \
    voxel-layers=7 \
    ncomponents=10 \
...
pixi run -e preprocessing \
    ...
    202506191452_20250619M205BICANRen36_VMSC32110 \
    region_UCI2424Q02Pu \
    /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506191452_20250619M205BICANRen36_VMSC32110/${PREFIX} \
    --type proseg \
    --prefix_name ${PREFIX} \
    --plot
