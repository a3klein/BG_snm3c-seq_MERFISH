...
#SBATCH -J cellpose_Ren36_UCI4723
#SBATCH -p gpu
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --gpus-per-node=1
#SBATCH --ntasks-per-node=64
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/Ren36/cellpose_Ren36_UCI4723.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/Ren36/cellpose_Ren36_UCI4723.out
#SBATCH --export=ALL
...
echo "Running Cellpose SAM on Region UCI4723 of Experiment Ren36"
...
pixi run -e cellpose \
    ...
    region_UCI4723Q02Pu \
    --input_dir /anvil/scratch/x-aklein2/BICAN/202506191452_20250619M205BICANRen36_VMSC32110/out/region_UCI4723Q02Pu/images \
