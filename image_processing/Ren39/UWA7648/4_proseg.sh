...
#SBATCH -A mcb130189
#SBATCH -J proseg_Ren39_UWA7648
#SBATCH -p wholenode
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=128
#SBATCH --mem=128gb
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/Ren39/proseg_Ren39_UWA7648.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/Ren39/proseg_Ren39_UWA7648.out
#SBATCH --export=ALL
...
pixi run -e preprocessing \
    ...
    --input_dir /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506271605_20250627M208BICANRen39_VMSC32010/cellpose/ \
    --output_dir /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506271605_20250627M208BICANRen39_VMSC32010/${PREFIX} \
    --kwargs \
    voxel-layers=7 \
    ncomponents=10 \
...
pixi run -e preprocessing \
    ...
    202506271605_20250627M208BICANRen39_VMSC32010 \
    region_UWA7648Q02MGM1 \
    /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506271605_20250627M208BICANRen39_VMSC32010/${PREFIX} \
    --type proseg \
    --prefix_name ${PREFIX} \
    --plot
...
pixi run -e preprocessing python src/spida/I/main.py allcools-integration-region \
    ...
    region_UWA7648Q02MGM1 \
    ${PREFIX} \
    /home/x-aklein2/projects/aklein/BICAN/data/reference/AIT/AIT_MGM_filtered.h5ad \
