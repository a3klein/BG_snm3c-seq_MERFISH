...
cd /home/x-aklein2/projects/aklein/BICAN/image_processing/Ren39/UCI5224
echo "Starting processing chain for Experiment Ren39 and Region UCI5224"
...
echo "Processing chain for Experiment Ren39 and Region UCI5224 has been initiated."