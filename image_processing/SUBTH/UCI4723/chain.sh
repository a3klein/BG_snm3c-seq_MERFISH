...
cd /home/x-aklein2/projects/aklein/BICAN/image_processing/SUBTH/UCI4723
echo "Starting processing chain for Experiment SUBTH and Region UCI4723"
...
echo "Processing chain for Experiment SUBTH and Region UCI4723 has been initiated."