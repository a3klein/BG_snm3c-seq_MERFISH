...
#SBATCH -A mcb130189
#SBATCH -J proseg_SUBTH_UCI2424
#SBATCH -p wholenode
#SBATCH --time=0:30:00
#SBATCH --nodes=1
#SBATCH --ntasks=128
#SBATCH --mem=128gb
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/SUBTH/proseg_SUBTH_UCI2424.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/SUBTH/proseg_SUBTH_UCI2424.out
#SBATCH --export=ALL
