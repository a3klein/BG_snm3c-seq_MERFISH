...
#SBATCH -J cellpose_SUBTH_UWA7648
#SBATCH -p gpu
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --gpus-per-node=1
#SBATCH --ntasks-per-node=64
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/SUBTH/cellpose_SUBTH_UWA7648.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/SUBTH/cellpose_SUBTH_UWA7648.out
#SBATCH --export=ALL
...
echo "Running Cellpose SAM on Region UWA7648 of Experiment SUBTH"
...
pixi run -e cellpose \
    ...
    region_UWA-7648 \
    --input_dir /anvil/scratch/x-aklein2/BICAN/202506291135_BICAN-4x1-SUBTH-E-05_VMSC31810/out/region_UWA-7648/images \
