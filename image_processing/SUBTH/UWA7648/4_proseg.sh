...
#SBATCH -A mcb130189
#SBATCH -J proseg_SUBTH_UWA7648
#SBATCH -p wholenode
#SBATCH --time=0:30:00
#SBATCH --nodes=1
#SBATCH --ntasks=128
#SBATCH --mem=128gb
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/SUBTH/proseg_SUBTH_UWA7648.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/SUBTH/proseg_SUBTH_UWA7648.out
#SBATCH --export=ALL
...
#     region_UWA-7648 \
#     --input_dir /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506291135_BICAN-4x1-SUBTH-E-05_VMSC31810/cellpose/ \
#     --output_dir /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506291135_BICAN-4x1-SUBTH-E-05_VMSC31810/${PREFIX} \
#     --kwargs \
#     voxel-layers=7 \
#     ncomponents=10 \
...
#     202506291135_BICAN-4x1-SUBTH-E-05_VMSC31810 \
#     region_UWA-7648 \
#     /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506291135_BICAN-4x1-SUBTH-E-05_VMSC31810/${PREFIX} \
#     --type proseg \
#     --prefix_name ${PREFIX} \
#     --plot
