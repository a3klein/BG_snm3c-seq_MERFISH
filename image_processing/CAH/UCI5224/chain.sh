...
cd /home/x-aklein2/projects/aklein/BICAN/image_processing/CAH/UCI5224
echo "Starting processing chain for Experiment CAH and Region UCI5224"
...
echo "Processing chain for Experiment CAH and Region UCI5224 has been initiated."