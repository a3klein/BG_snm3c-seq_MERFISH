...
#SBATCH -J cellpose_CAH_UCI2424
#SBATCH -p gpu
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --gpus-per-node=1
#SBATCH --ntasks-per-node=64
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/CAH/cellpose_CAH_UCI2424.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/CAH/cellpose_CAH_UCI2424.out
#SBATCH --export=ALL
...
echo "Running Cellpose SAM on Region UCI2424 of Experiment CAH"
...
pixi run -e cellpose \
    ...
    --input_dir /anvil/scratch/x-aklein2/BICAN/202506151211_BICAN4x1-CAH-E03_VMSC31810/out/region_UCI2424-CAH-E3/images \
