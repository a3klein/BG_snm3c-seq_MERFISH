...
#SBATCH -J cellpose_CAH_UCI4723
#SBATCH -p gpu
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --gpus-per-node=1
#SBATCH --ntasks-per-node=64
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/CAH/cellpose_CAH_UCI4723.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/CAH/cellpose_CAH_UCI4723.out
#SBATCH --export=ALL
...
echo "Running Cellpose SAM on Region UCI4723 of Experiment CAH"
...
pixi run -e cellpose \
    ...
    --input_dir /anvil/scratch/x-aklein2/BICAN/202506151211_BICAN4x1-CAH-E03_VMSC31810/out/region_UCI4723-CAH-E3/images \
    --output_dir /anvil/projects/x-mcb130189/aklein/BICAN/data/segmented/202506151211_BICAN4x1-CAH-E03_VMSC31810/cellpose \
    --kwargs \
    scale=4 \
    image_ext=.decon.tif \
    nuc_stain_name=DAPI \
