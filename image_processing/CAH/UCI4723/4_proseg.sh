...
#SBATCH -A mcb130189
#SBATCH -J proseg_CAH_UCI4723
#SBATCH -p wholenode
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=128
#SBATCH --mem=128gb
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/CAH/proseg_CAH_UCI4723.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/CAH/proseg_CAH_UCI4723.out
#SBATCH --export=ALL
...
pixi run -e preprocessing \
    ...
    --input_dir /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506151211_BICAN4x1-CAH-E03_VMSC31810/cellpose/ \
    --output_dir /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506151211_BICAN4x1-CAH-E03_VMSC31810/${PREFIX} \
    --kwargs \
    voxel-layers=7 \
    ncomponents=10 \
...
pixi run -e preprocessing \
    ...
    202506151211_BICAN4x1-CAH-E03_VMSC31810 \
    region_UCI4723-CAH-E3 \
    /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506151211_BICAN4x1-CAH-E03_VMSC31810/${PREFIX} \
    --type proseg \
    --prefix_name ${PREFIX} \
    --plot
