...
#SBATCH -J cellpose_Ren41_UCI5224
#SBATCH -p gpu
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --gpus-per-node=1
#SBATCH --ntasks-per-node=64
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/Ren41/cellpose_Ren41_UCI5224.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/Ren41/cellpose_Ren41_UCI5224.out
#SBATCH --export=ALL
...
echo "Running Cellpose SAM on Region UCI5224 of Experiment Ren41"
...
pixi run -e cellpose \
    ...
    --input_dir /anvil/scratch/x-aklein2/BICAN/202507041709_20250704M211BICANRen41_VMSC32010/out/region_UCI5224Q04SubT/images \
    --output_dir /anvil/projects/x-mcb130189/aklein/BICAN/data/segmented/202507041709_20250704M211BICANRen41_VMSC32010/cellpose \
    --kwargs \
    scale=4 \
    image_ext=.decon.tif \
    nuc_stain_name=DAPI \
