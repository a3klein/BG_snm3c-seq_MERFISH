...
#SBATCH -A mcb130189
#SBATCH -J proseg_Ren40_UCI4723
#SBATCH -p wholenode
#SBATCH --time=0:30:00
#SBATCH --nodes=1
#SBATCH --ntasks=128
#SBATCH --mem=128gb
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/Ren40/proseg_Ren40_UCI4723.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/Ren40/proseg_Ren40_UCI4723.out
#SBATCH --export=ALL
...
#     --input_dir /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506301111_20250630M210BICANRen40_VMSC32010/cellpose/ \
#     --output_dir /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506301111_20250630M210BICANRen40_VMSC32010/${PREFIX} \
#     --kwargs \
#     voxel-layers=7 \
#     ncomponents=10 \
...
#     202506301111_20250630M210BICANRen40_VMSC32010 \
#     region_UCI4723Q04NAC \
#     /home/x-aklein2/projects/aklein/BICAN/data/segmented/202506301111_20250630M210BICANRen40_VMSC32010/${PREFIX} \
#     --type proseg \
#     --prefix_name ${PREFIX} \
#     --plot
...
pixi run -e preprocessing python src/spida/I/main.py allcools-integration-region \
    ...
    region_UCI4723Q04NAC \
    ${PREFIX} \
    /home/x-aklein2/projects/aklein/BICAN/data/reference/AIT/AIT_NAC_filtered.h5ad \
