...
cd /home/x-aklein2/projects/aklein/BICAN/image_processing/GP/UCI5224
echo "Starting processing chain for Experiment GP and Region UCI5224"
...
echo "Processing chain for Experiment GP and Region UCI5224 has been initiated."