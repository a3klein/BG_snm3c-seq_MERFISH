...
#SBATCH -J cellpose_GP_UCI5224
#SBATCH -p gpu
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --gpus-per-node=1
#SBATCH --ntasks-per-node=64
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/GP/cellpose_GP_UCI5224.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/GP/cellpose_GP_UCI5224.out
#SBATCH --export=ALL
...
echo "Running Cellpose SAM on Region UCI5224 of Experiment GP"
...
pixi run -e cellpose \
    ...
    region_UCI5224 \
    --input_dir /anvil/scratch/x-aklein2/BICAN/202506171319_BICAN-4x1-GP-E-05_VMSC31910/out/region_UCI5224/images \
