...
cd /home/x-aklein2/projects/aklein/BICAN/image_processing/GP/UWA7648
echo "Starting processing chain for Experiment GP and Region UWA7648"
...
echo "Processing chain for Experiment GP and Region UWA7648 has been initiated."