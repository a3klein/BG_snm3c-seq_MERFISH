...
cd /home/x-aklein2/projects/aklein/BICAN/image_processing/GP/UCI2424
echo "Starting processing chain for Experiment GP and Region UCI2424"
...
echo "Processing chain for Experiment GP and Region UCI2424 has been initiated."