...
cd /home/x-aklein2/projects/aklein/BICAN/image_processing/CAB/UCI4723
echo "Starting processing chain for Experiment CAB and Region UCI4723"
...
echo "Processing chain for Experiment CAB and Region UCI4723 has been initiated."