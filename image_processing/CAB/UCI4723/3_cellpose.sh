...
#SBATCH -J cellpose_CAB_UCI4723
#SBATCH -p gpu
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --gpus-per-node=1
#SBATCH --ntasks-per-node=64
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/CAB/cellpose_CAB_UCI4723.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/CAB/cellpose_CAB_UCI4723.out
#SBATCH --export=ALL
...
echo "Running Cellpose SAM on Region UCI4723 of Experiment CAB"
...
pixi run -e cellpose \
    ...
    --input_dir /anvil/scratch/x-aklein2/BICAN/202506171319_BICAN4x1-CAB-E01_VMSC31810/out/region_UCI4723-CAB-E1/images \
