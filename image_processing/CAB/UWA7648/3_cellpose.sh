...
#SBATCH -J cellpose_CAB_UWA7648
#SBATCH -p gpu
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --gpus-per-node=1
#SBATCH --ntasks-per-node=64
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/CAB/cellpose_CAB_UWA7648.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/CAB/cellpose_CAB_UWA7648.out
#SBATCH --export=ALL
...
echo "Running Cellpose SAM on Region UWA7648 of Experiment CAB"
...
pixi run -e cellpose \
    ...
    --input_dir /anvil/scratch/x-aklein2/BICAN/202506171319_BICAN4x1-CAB-E01_VMSC31810/out/region_UWA7648-CAB-E1/images \
    --output_dir /anvil/projects/x-mcb130189/aklein/BICAN/data/segmented/202506171319_BICAN4x1-CAB-E01_VMSC31810/cellpose \
    --kwargs \
    scale=4 \
    image_ext=.decon.tif \
    nuc_stain_name=DAPI \
