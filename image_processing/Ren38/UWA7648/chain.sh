...
cd /home/x-aklein2/projects/aklein/BICAN/image_processing/Ren38/UWA7648
echo "Starting processing chain for Experiment Ren38 and Region UWA7648"
...
echo "Processing chain for Experiment Ren38 and Region UWA7648 has been initiated."