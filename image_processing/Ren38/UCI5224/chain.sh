...
cd /home/x-aklein2/projects/aklein/BICAN/image_processing/Ren38/UCI5224
echo "Starting processing chain for Experiment Ren38 and Region UCI5224"
...
echo "Processing chain for Experiment Ren38 and Region UCI5224 has been initiated."