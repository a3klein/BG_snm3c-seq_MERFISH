...
#SBATCH -J cellpose_Ren38_UCI5224
#SBATCH -p gpu
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --gpus-per-node=1
#SBATCH --ntasks-per-node=64
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/Ren38/cellpose_Ren38_UCI5224.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/Ren38/cellpose_Ren38_UCI5224.out
#SBATCH --export=ALL
...
echo "Running Cellpose SAM on Region UCI5224 of Experiment Ren38"
...
pixi run -e cellpose \
    ...
    --input_dir /anvil/scratch/x-aklein2/BICAN/202506221351_20250622M207BICANRen38_VMSC32110/out/region_UCI5224Q02CaB/images \
