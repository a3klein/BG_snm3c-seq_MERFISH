...
cd /home/x-aklein2/projects/aklein/BICAN/image_processing/Ren38/UCI2424
echo "Starting processing chain for Experiment Ren38 and Region UCI2424"
...
echo "Processing chain for Experiment Ren38 and Region UCI2424 has been initiated."