...
cd /home/x-aklein2/projects/aklein/BICAN/image_processing/Ren38/UCI4723
echo "Starting processing chain for Experiment Ren38 and Region UCI4723"
...
echo "Processing chain for Experiment Ren38 and Region UCI4723 has been initiated."