...
#SBATCH -J cellpose_Ren37_UCI5224
#SBATCH -p gpu
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --gpus-per-node=1
#SBATCH --ntasks-per-node=64
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/Ren37/cellpose_Ren37_UCI5224.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/Ren37/cellpose_Ren37_UCI5224.out
#SBATCH --export=ALL
...
echo "Running Cellpose SAM on Region UCI5224 of Experiment Ren37"
...
pixi run -e cellpose \
    ...
    region_UCI5224Q04GP \
    --input_dir /anvil/scratch/x-aklein2/BICAN/202506221225_20250622M206BICANRen37_VMSC32010/out/region_UCI5224Q04GP/images \
    --output_dir /anvil/projects/x-mcb130189/aklein/BICAN/data/segmented/202506221225_20250622M206BICANRen37_VMSC32010/cellpose \
    --kwargs \
    scale=4 \
    image_ext=.decon.tif \
    nuc_stain_name=DAPI \
