...
#SBATCH -J cellpose_Ren37_UCI4723
#SBATCH -p gpu
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --gpus-per-node=1
#SBATCH --ntasks-per-node=64
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/Ren37/cellpose_Ren37_UCI4723.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/Ren37/cellpose_Ren37_UCI4723.out
#SBATCH --export=ALL
...
echo "Running Cellpose SAM on Region UCI4723 of Experiment Ren37"
...
pixi run -e cellpose \
    ...
    region_UCI4723Q04GP \
    --input_dir /anvil/scratch/x-aklein2/BICAN/202506221225_20250622M206BICANRen37_VMSC32010/out/region_UCI4723Q04GP/images \
