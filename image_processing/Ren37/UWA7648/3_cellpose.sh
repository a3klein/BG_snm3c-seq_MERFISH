...
#SBATCH -J cellpose_Ren37_UWA7648
#SBATCH -p gpu
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --gpus-per-node=1
#SBATCH --ntasks-per-node=64
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/Ren37/cellpose_Ren37_UWA7648.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/Ren37/cellpose_Ren37_UWA7648.out
#SBATCH --export=ALL
...
echo "Running Cellpose SAM on Region UWA7648 of Experiment Ren37"
...
pixi run -e cellpose \
    ...
    region_UWA7648Q04GP \
    --input_dir /anvil/scratch/x-aklein2/BICAN/202506221225_20250622M206BICANRen37_VMSC32010/out/region_UWA7648Q04GP/images \
