...
#SBATCH -A mcb130189
#SBATCH -J agg_exp_cah
#SBATCH -p wholenode
#SBATCH --time=1:00:00
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --mem=128gb
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/agg/proseg_cah.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/agg/proseg_cah.out
#SBATCH --export=ALL
...
experiment_list='202506191430_20250619M204BICANRen35_VMSC32010'
...
pixi run -e preprocessing \
    ...
    --suffix _filt \
    --lab_name ucsd \
    --project_name BICAN_BG_CAH

echo -e "\n DONE \n"

pixi run -e preprocessing python -m spida.P.cli setup-dataset BICAN_BG_CAH_ucsd_proseg_fv38_filt
...
experiment_list='202506151211_BICAN4x1-CAH-E03_VMSC31810'
...
pixi run -e preprocessing python -m spida.P.cli setup-dataset BICAN_BG_CAH_salk_proseg_fv38_filt
