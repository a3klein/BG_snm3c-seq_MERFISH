...
#SBATCH -A mcb130189
#SBATCH -J agg_exp_cab
#SBATCH -p wholenode
#SBATCH --time=1:00:00
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --mem=128gb
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/agg/proseg_cab.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/agg/proseg_cab.out
#SBATCH --export=ALL
...
experiment_list='202506221351_20250622M207BICANRen38_VMSC32110'
...
pixi run -e preprocessing \
    ...
    --suffix _filt \
    --lab_name ucsd \
    --project_name BICAN_BG_CAB

echo -e "\n DONE \n"

pixi run -e preprocessing python -m spida.P.cli setup-dataset BICAN_BG_CAB_ucsd_proseg_fv38_filt
...
experiment_list='202506171319_BICAN4x1-CAB-E01_VMSC31810'
...
pixi run -e preprocessing python -m spida.P.cli setup-dataset BICAN_BG_CAB_salk_proseg_fv38_filt
