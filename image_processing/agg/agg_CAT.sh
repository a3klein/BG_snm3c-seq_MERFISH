...
#SBATCH --mem=128gb
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/agg/proseg_cat.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/agg/proseg_cat.out
#SBATCH --export=ALL
...
pixi run -e preprocessing python -m spida.P.cli setup-dataset BICAN_BG_CAT_ucsd_proseg_fv38_filt
...
pixi run -e preprocessing python -m spida.P.cli setup-dataset BICAN_BG_CAT_salk_proseg_fv38_filt
